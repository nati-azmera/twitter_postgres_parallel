...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/nati-azmera/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/nati-azmera/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/nati-azmera/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/nati-azmera/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/nati-azmera/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/nati-azmera/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 561.48s                   |  59.67s                    | 
| `pg_normalized_batch`  |  172.02s                  |14.86s                      | 
| `pg_denormalized`      | 21.12s                    |3.78s                       | 
